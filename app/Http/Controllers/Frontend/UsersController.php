...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::with(['roles', 'departments', 'team', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.users.create', compact('departments', 'roles', 'teams'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('frontend.users.edit', compact('departments', 'roles', 'teams', 'user'));
    }
