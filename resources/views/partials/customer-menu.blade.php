<aside class="main-sidebar sidebar-dark-primary customer-sidebar" style="min-height: 917px;">
    <!-- Brand Logo -->
        ...
        @if(auth()->user()->is_customer)
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @can('company_access')
                    <li class="nav-item">
                        <a href="{{ route("customer.companies.index") }}" class="nav-link {{ request()->is("customer/companies") || request()->is("customer/companies/*") ? "active" : "" }}">
                    ...
                    @endcan
                    @can('invoice_access')
                        <li class="nav-item has-treeview {{ request()->is("customer/invoice") || request()->is("customer/invoice/*") ? "menu-open" : "" }} {{ request()->get("type")=="myrequests" || request()->get("type")=="paid" || request()->get("type")=="unpaid" ? "menu-open active" : "" }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route("customer.invoices.index",['type'=>'myrequests']) }}" class="nav-link {{ request()->get("type")=="myrequests" ? "active" : "" }}">
                                    <i class="fa-fw nav-icon fas fa-receipt"></i>
                                </i>
                                <p>
                            ...
                            @can('paid_invoice_access')
                                <li class="nav-item">
                                    <a href="{{ route("customer.invoices.index",['type'=>'paid']) }}" class="nav-link {{ request()->get("type")=="paid" ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-receipt"></i>
                                    <p>
                            ...
                            @can('unpaid_invoice_access')
                                <li class="nav-item">
                                    <a href="{{ route("customer.invoices.index",['type'=>'unpaid']) }}" class="nav-link {{ request()->get("type")=="unpaid" ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-receipt"></i>
                                        <p>
                    ...
                    @can('customer_team_management_access')
                    <li class="nav-item has-treeview {{ request()->is("customer/team") || request()->is("customer/team/*") ? "menu-open" : "" }} {{ request()->is("customer/team-head") || request()->is("customer/team-head/*") ? "menu-open" : "" }} {{request()->get("type")=="team" ? "menu-open active" : "" }} {{request()->get("type")=="team_head" ? "menu-open active" : "" }}">
                      <a class="nav-link nav-dropdown-toggle" href="#">
                          <i class="bi bi-microsoft-teams"></i>
                          <p>
                              {{ trans('cruds.customer.fields.team_management') }}
                              <i class="right fa fa-fw fa-angle-left nav-icon"></i>
                          </p>
                      </a>
                      <ul class="nav nav-treeview">
                      @can('customer_team_head_access')
                      <li class="nav-item">
                          <a href="{{ route("customer.team-head.index",['type'=>'team_head']) }}" class="nav-link {{request()->get("type")=="team_head" ? "active" : "" }}">
                              <i class="bi bi-microsoft-teams"></i>
                          </i>
                          <p>
                              {{ trans('cruds.customer.fields.team_head') }}
                          </p>
                          </a>
                      </li>
                      @endcan
                      @can('customer_team_create')
                      <li class="nav-item">
                          <a href="{{ route("customer.team.index",['type'=>'team']) }}" class="nav-link {{request()->get("type")=="team" ? "active" : "" }}">
                              <i class="bi bi-microsoft-teams"></i>
                          </i>
                          <p>
                              {{ trans('cruds.customer.fields.team_members') }}
                          </p>
                          </a>
                      </li>
                      @endcan
                    ...
                    @endcan
                    @elseif($user->team_id != $company_role_user->user_id)
                    ...
                    @endcan
                    @can('master_access')
                        <li class="nav-item has-treeview {{ request()->is("admin/customers*") ? "menu-open" : "" }} {{ request()->is("admin/vendors*") ? "menu-open" : "" }} {{ request()->is("admin/companies*") ? "menu-open" : "" }} {{ request()->is("admin/terms*") ? "menu-open" : "" }} {{ request()->is("admin/account-types*") ? "menu-open" : "" }} {{ request()->is("admin/account-names*") ? "menu-open" : "" }}">
                            <a class="nav-link nav-dropdown-toggle" href="#">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @can('company_access')
                                    <li class="nav-item has-treeview {{ request()->is("admin/customers*") ? "menu-open" : "" }} {{ request()->is("admin/vendors*") ? "menu-open" : "" }} {{ request()->is("admin/companies*") ? "menu-open" : "" }} {{ request()->is("admin/terms*") ? "menu-open" : "" }} {{ request()->is("admin/account-types*") ? "menu-open" : "" }} {{ request()->is("admin/account-names*") ? "menu-open" : "" }}">
                                        <a class="nav-link {{ request()->is("admin/companies") || request()->is("admin/companies/*") ? "active" : "" }}">
                    ...
                    @endcan
                    @can('sale_access')
                        <li class="nav-item has-treeview {{ request()->is("admin/products*") ? "menu-open" : "" }} {{ request()->is("admin/invoices*") ? "menu-open" : "" }} {{ request()->is("admin/invoice-details*") ? "menu-open" : "" }}">
                            <a class="nav-link nav-dropdown-toggle" href="#">
