                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.companies.update", [$company->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username_for_pan_tan" id="username_for_pan_tan" value="{{ old('username_for_pan_tan', $company->username_for_pan_tan) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password_for_pan_tan" id="password_for_pan_tan" value="{{ old('password_for_pan_tan', $company->password_for_pan_tan) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username_for_gst_vat_icegate_dgft" id="username_for_gst_vat_icegate_dgft" value="{{ old('username_for_gst_vat_icegate_dgft', $company->username_for_gst_vat_icegate_dgft) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password_for_gst_vat_icegate_dgft" id="password_for_gst_vat_icegate_dgft" value="{{ old('password_for_gst_vat_icegate_dgft', $company->password_for_gst_vat_icegate_dgft) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username_for_e_way_e_invoicing" id="username_for_e_way_e_invoicing" value="{{ old('username_for_e_way_e_invoicing', $company->username_for_e_way_e_invoicing) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password_for_e_way_e_invoicing" id="password_for_e_way_e_invoicing" value="{{ old('password_for_e_way_e_invoicing', $company->password_for_e_way_e_invoicing) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username_for_traces" id="username_for_traces" value="{{ old('username_for_traces', $company->username_for_traces) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password_for_traces" id="password_for_traces" value="{{ old('password_for_traces', $company->password_for_traces) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username_for_pf_esi_and_other_labour_law" id="username_for_pf_esi_and_other_labour_law" value="{{ old('username_for_pf_esi_and_other_labour_law', $company->username_for_pf_esi_and_other_labour_law) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password_for_pf_esi_and_other_labour_law" id="password_for_pf_esi_and_other_labour_law" value="{{ old('password_for_pf_esi_and_other_labour_law', $company->password_for_pf_esi_and_other_labour_law) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username_for_reporting_portal" id="username_for_reporting_portal" value="{{ old('username_for_reporting_portal', $company->username_for_reporting_portal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password_for_reporting_portal" id="password_for_reporting_portal" value="{{ old('password_for_reporting_portal', $company->password_for_reporting_portal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gstin" id="gstin" value="{{ old('gstin', $company->gstin) }}" required>
                            @if($errors->has('gstin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('gstin') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address_line_1" id="address_line_1" value="{{ old('address_line_1', $company->address_line_1) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address_line_2" id="address_line_2" value="{{ old('address_line_2', $company->address_line_2) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cin" id="cin" value="{{ old('cin', $company->cin) }}" required>
                            @if($errors->has('cin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cin') }}
                                </div>
