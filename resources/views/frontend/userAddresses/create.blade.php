                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.user-addresses.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="text" name="addressline_2" id="addressline_2" value="{{ old('addressline_2', '') }}">
                        ...
                        <div class="form-group col-md-4">
                            <div>
                                ...
                                <input type="checkbox" name="same_as" id="same_as" value="1" {{ old('same_as', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group col-md-4">
                            <div>
                                ...
                                <input type="checkbox" name="default_address" id="default_address" value="1" {{ old('default_address', 0) == 1 ? 'checked' : '' }}>
