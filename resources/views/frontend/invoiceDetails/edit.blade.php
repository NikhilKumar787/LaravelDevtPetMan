                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.invoice-details.update", [$invoiceDetail->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty" id="qty" value="{{ old('qty', $invoiceDetail->qty) }}" step="1" required>
                            @if($errors->has('qty'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rate" id="rate" value="{{ old('rate', $invoiceDetail->rate) }}" step="0.01" required>
                            @if($errors->has('rate'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('rate') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $invoiceDetail->amount) }}" step="0.01" required>
