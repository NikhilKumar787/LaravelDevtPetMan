                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vendors.update", [$vendor->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $vendor->first_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $vendor->middle_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $vendor->last_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="company_name" id="company_name" value="{{ old('company_name', $vendor->company_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gstin" id="gstin" value="{{ old('gstin', $vendor->gstin) }}">
                            @if($errors->has('gstin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('gstin') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address" id="address">{{ old('address', $vendor->address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pin_code" id="pin_code" value="{{ old('pin_code', $vendor->pin_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $vendor->mobile) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $vendor->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pancard" id="pancard" value="{{ old('pancard', $vendor->pancard) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other" id="other" value="{{ old('other', $vendor->other) }}">
                            @if($errors->has('other'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('other') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="notes" id="notes">{{ old('notes', $vendor->notes) }}</textarea>
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_method" id="payment_method" value="{{ old('payment_method', $vendor->payment_method) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="account_no" id="account_no" value="{{ old('account_no', $vendor->account_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tax_reg_no" id="tax_reg_no" value="{{ old('tax_reg_no', $vendor->tax_reg_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="effective_date" id="effective_date" value="{{ old('effective_date', $vendor->effective_date) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="apply_tds" id="apply_tds" value="1" {{ $vendor->apply_tds || old('apply_tds', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="calculation_threshold" id="calculation_threshold" value="1" {{ $vendor->calculation_threshold || old('calculation_threshold', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_my_customer" id="is_my_customer" value="1" {{ $vendor->is_my_customer || old('is_my_customer', 0) === 1 ? 'checked' : '' }}>
