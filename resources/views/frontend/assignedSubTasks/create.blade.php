    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assigned-sub-tasks.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="hours_estimation" id="hours_estimation" value="{{ old('hours_estimation', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="target_date" id="target_date" value="{{ old('target_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="completed_date" id="completed_date" value="{{ old('completed_date') }}">
