    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assigned-task-details.update", [$assignedTaskDetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $assignedTaskDetail->date) }}">
                            @if($errors->has('date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('date') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="start_time" id="start_time" value="{{ old('start_time', $assignedTaskDetail->start_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="end_time" id="end_time" value="{{ old('end_time', $assignedTaskDetail->end_time) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_approved" id="is_approved" value="1" {{ $assignedTaskDetail->is_approved || old('is_approved', 0) === 1 ? 'checked' : '' }}>
