                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hsn" id="hsn" value="{{ old('hsn', '') }}">
                            @if($errors->has('hsn'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('hsn') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sales_price" id="sales_price" value="{{ old('sales_price', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Product::TAX_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="tax_type_{{ $key }}" name="tax_type" value="{{ $key }}" {{ old('tax_type', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control py-0" name="gst" id="gst">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cess" id="cess" value="{{ old('cess', '') }}" step="1">
                            @if($errors->has('cess'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cess') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control py-0" name="cess_type" id="cess_type">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control py-0" name="price_type" id="price_type">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Product::ITEM_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="item_type_{{ $key }}" name="item_type" value="{{ $key }}" {{ old('item_type', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="wholesale_price" id="wholesale_price" value="{{ old('wholesale_price', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control py-0" name="income_account_type" id="income_account_type" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control py-0" name="account_group" id="account_group" required>
