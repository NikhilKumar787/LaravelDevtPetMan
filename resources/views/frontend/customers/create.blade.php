                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.customers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gst_customer_name" id="gst_customer_name" value="{{ old('gst_customer_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tan" id="tan" value="{{ old('tan', '') }}">
                            @if($errors->has('tan'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tan') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control py-0" name="delivery_method" id="delivery_method">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="optional_data_1" id="optional_data_1" value="{{ old('optional_data_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="optional_data_2" id="optional_data_2" value="{{ old('optional_data_2', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_my_vendor" id="is_my_vendor" value="1" {{ old('is_my_vendor', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="modal-body">
                <form method="" action="" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="form-group row no-gutters ml-4 mt-2">
                        <div class="col-sm-2">
                          <input type="text" class="form-control py-0" name="day_of_month" id="credit_period_days2">
                        </div>
    ...
    $(document).ready(function(){
       ...
       function formatRepoSelection (repo) {
        ...
        $("#group_save").click(function(){
            ...
            $.ajax({
                url: "{{ route('frontend.group-store')}}",
                type: "get",
