    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vendors.update", [$vendor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" name="title" id="title" required>
                    ...
                    @foreach(App\Models\Vendor::TITLE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('title', $vendor->title) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $vendor->first_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('middle_name') ? 'is-invalid' : '' }}" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $vendor->middle_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $vendor->last_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text" name="company_name" id="company_name" value="{{ old('company_name', $vendor->company_name) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gst_type') ? 'is-invalid' : '' }}" name="gst_type" id="gst_type" required>
                    ...
                    @foreach(App\Models\Vendor::GST_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gst_type', $vendor->gst_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gstin') ? 'is-invalid' : '' }}" type="text" name="gstin" id="gstin" value="{{ old('gstin', $vendor->gstin) }}">
                @if($errors->has('gstin'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $vendor->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('state') ? 'is-invalid' : '' }}" name="state_id" id="state_id">
                    @foreach($states as $id => $entry)
                        <option value="{{ $id }}" {{ (old('state_id') ? old('state_id') : $vendor->state->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('state'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pin_code') ? 'is-invalid' : '' }}" type="text" name="pin_code" id="pin_code" value="{{ old('pin_code', $vendor->pin_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $vendor->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pancard') ? 'is-invalid' : '' }}" type="text" name="pancard" id="pancard" value="{{ old('pancard', $vendor->pancard) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other') ? 'is-invalid' : '' }}" type="text" name="other" id="other" value="{{ old('other', $vendor->other) }}">
                @if($errors->has('other'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $vendor->notes) }}</textarea>
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_method') ? 'is-invalid' : '' }}" type="text" name="payment_method" id="payment_method" value="{{ old('payment_method', $vendor->payment_method) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('term') ? 'is-invalid' : '' }}" name="term_id" id="term_id">
                    @foreach($terms as $id => $entry)
                        <option value="{{ $id }}" {{ (old('term_id') ? old('term_id') : $vendor->term->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('term'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_no') ? 'is-invalid' : '' }}" type="text" name="account_no" id="account_no" value="{{ old('account_no', $vendor->account_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_reg_no') ? 'is-invalid' : '' }}" type="text" name="tax_reg_no" id="tax_reg_no" value="{{ old('tax_reg_no', $vendor->tax_reg_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('effective_date') ? 'is-invalid' : '' }}" type="text" name="effective_date" id="effective_date" value="{{ old('effective_date', $vendor->effective_date) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('apply_tds') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="apply_tds" id="apply_tds" value="1" {{ $vendor->apply_tds || old('apply_tds', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('entity') ? 'is-invalid' : '' }}" name="entity" id="entity">
                    ...
                    @foreach(App\Models\Vendor::ENTITY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('entity', $vendor->entity) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('section') ? 'is-invalid' : '' }}" name="section" id="section">
                    ...
                    @foreach(App\Models\Vendor::SECTION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('section', $vendor->section) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('calculation_threshold') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="calculation_threshold" id="calculation_threshold" value="1" {{ $vendor->calculation_threshold || old('calculation_threshold', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_my_customer') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_my_customer" id="is_my_customer" value="1" {{ $vendor->is_my_customer || old('is_my_customer', 0) === 1 ? 'checked' : '' }}>
