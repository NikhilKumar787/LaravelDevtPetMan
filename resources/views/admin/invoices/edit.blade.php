...
<form method="POST" action="{{ route("admin.invoices.update", [$invoice->id]) }}" enctype="multipart/form-data">
    ...
    <div class="invoice-add">
        <div class="d-flex flex-row justify-content-between align-items-center">
            <h2 class="font-weight-bold my-3">Invoice</h2>
            <i class="bi bi-gear" id="setting-btn"></i>
        </div>
        <div class="invoice-upper">
            <div class="form-check mb-2">
               <input type="hidden" name="invoice_request" value="1">
               <input  class="form-control" type="hidden" name="completed_date" id="payment_date" value="<?php echo date('Y-m-d'); ?>">


                <input type="hidden" name="hidden_invoice_type" value="{{request()->get('type')}}">
                <input type="hidden" id="review_invoice_id" value="{{$invoice->id}}">
                <input hidden class="form-check-input" type="checkbox" checked name="invoice_request" id="invoice_request" value="1" {{ old('invoice_request', 0) == 1 ? 'checked' : '' }}>
                <label hidden class="form-check-label"  for="invoice_request">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ isset($company->company_name) ? $company->company_name : '' }}" readonly>    
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="custom_id" value="">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                ...
                <input type="email" class="form-control" id="customer_email"  value="{{ old('customer_email', $invoice->customer_email) }}" name="customer_email">
                <input type="hidden" id="customer_state_id" value="{{isset($invoice->customer->state_id)}}">
                </div>
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="po_no"  value="{{$invoice->po_no}}" name="po_no">
                </div>
            </div>
            {{-- <div class="col-md-3">
        ...
        <div class="row mt-2">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="address" name="billing_address" placeholder="" rows="3">{{ old('billing_address', $invoice->billing_address) }}</textarea>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="ship_address" name="shipping_address" placeholder="" rows="3">{{ old('shipping_address', $invoice->shipping_address) }}</textarea>
                </div>
            </div>
                <div class="col-md-2">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="selected_bank">Select Bank Details</label>
                        <input type="hidden" id="selected_bank" name="selected_bank" value="{{ isset($invoice->bank_details->id) ? $invoice->bank_details->id : '' }}">
                        <input class="form-control" type="text" value="{{ isset($invoice->bank_details->bank_name) ? $invoice->bank_details->bank_name : '' }}" readonly>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="invoice_date">Invoice Date</label>
                        <input type="date" class="form-control" id="invoice_date"  value="{{ old('invoice_date', $invoice->invoice_date) }}" name="invoice_date">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="due_date" value="{{ old('due_date', $invoice->due_date) }}" name="due_date" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="text-transform: uppercase" id="invoice_prefix" value="{{ old('invoice_prefix', $invoice->invoice_prefix) }}" name="invoice_prefix">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="invoice_no">Invoice No.</label>
                        <input type="text" class="form-control" id="invoice_no" value="{{ old('invoice_no', $invoice->invoice_no) }}" name="invoice_no">
                    </div>
                </div>
            </div>
            <!-- Here we are listing of edit Custom Fields -->
            <div id="list_of_edit_custom_fields" class="row">
        ...
        <thead>
            ...
            {{-- <th scope="col">#</th> --}}
            @if(auth()->user()->id != 1)
            <th scope="col" style="width: 7%">Review Product</th>
            @endif
        ...
        <tbody>
            ...
            <tr data-index="1">
            {{-- <th scope="row">1</th> --}}
            <!-- Here a Button of Review Product -->
            @if(auth()->user()->id != 1)
            @if($invoice_detail->product->is_employee_approved == 0)l
            <td style="width: 7%">
                <button type="button" class="btn btn-xs btn-warning product_review_modal" product_id="{{ isset($invoice_detail->product->id) ? $invoice_detail->product->id : '' }}">Product Review</button>
            </td>
            @else
            <td style="width: 7%" class="text text-success font-weight-bolder">Done</td>
            @endif
            @endif
            <td style="width: 15%">
                <select class="form-control select2 product_class product_id {{ $errors->has('product') ? 'is-invalid' : '' }}" data-attr="1" id="product_id" name="product_id[]">
                    ...
                    <option value="{{ $key }}" {{$invoice_detail->product->id == $key ? 'selected' : '' }}>
                        {{ $label }}</option>
                    @endforeach
                </select>
            </td>
            @if($invoice_detail->product->item_type == 'G')
                <td class="service_date_td" style="width: 13%"> <input hidden selected type="date" class="form-control" id="service_date" name="service_date[]"></td>
            
            @else
                <td class="service_date_td" style="width: 13%"> <input selected type="date" class="form-control" id="service_date" name="service_date[]" required></td>
            @endif
            
            <td style="width: 11%"><input type="text" class="form-control hsn_sac" id="hsn_sac" value="{{ $invoice_detail->product->hsn }}" name="hsn_sac[]" required></td>
            <td style="width: 7%"><input type="text" class="form-control quantity" id="quantity" name="quantity[]" value="{{ $invoice_detail->qty }}" required></td>
            <td style="width: 10%"><input type="text" class="form-control rate" id="rate" name="rate[]" value="{{ $invoice_detail->rate }}" placeholder="0.00" required></td>
            <td style="width: 10%"><input type="text" class="form-control amount_inv" id="amount_inv" name="amount_inv[]" value="{{ $invoice_detail->amount }}" placeholder="0.00" required></td>
            <td style="width: 15%">
                <select class="form-control py-0 tax_gst {{ $errors->has('tax_gst') ? 'is-invalid' : '' }}" name="tax_gst[]" id="tax_gst" required>
                    <option value disabled {{ old('tax_gst', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach($gsts as $gst)
                    <option value="{{ $gst->gst }}" {{  $gst->gst == $invoice_detail->tax ? 'selected' : '' }}>GST @ {{ $gst->gst }}%</option>
                    @endforeach
                </select>
            ...
            <tr data-index="1" class="remove_1">
                <td style="width: 50%" colspan="4"><textarea type="text" class="form-control description_inv" id="description_inv" name="description_inv[]" placeholder="Enter the Product Description Here">{{ $invoice_detail->product->description }}</textarea></td>
            </tr>
            @endforeach
        </tbody>
        </table>
            ...
            <div class="mt-3">
                ...
                <div class="form-group">
                    ...
                    @foreach($terms_and_conditions as $id => $entry)
                        <option value="{{ $id }}" {{ (old('terms_and_condition_id') ? old('terms_and_condition_id') : $invoice->terms_and_condition->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="message_on_statement" name="message_on_statement" placeholder="If you send statements to customers, this will show up as the description for this invoice." rows="3">{{ old('message_on_statement', $invoice->message_on_statement) }}</textarea>
                </div>
    ...
    <div class="row form-group justify-content-between">
        <div class="form-group" style="margin-left: 40px; font-weight:bolder;">
            @if(auth()->user()->id != 1)
            <input class="form-check-input" type="checkbox" name="invoice_approval_request" id="invoice_approval_request" value="1" {{ old('invoice_approval_request', 1) == 0 ? 'checked' : '' }}>
            <label class="form-check-label"  for="invoice_approval_request">
            Invoice Approved
            </label>
            @endif
        </div>
  ...
  <div class="manage-invoice-bg">
    ...
    <div class="settings-group-controls">
        ...
        <div class="d-flex justify-content-start">
            ...
            </label><h6 class="print3">Include Inactive</h6>
        </div>
                ...
                <div class="">
                    ...
                    <input type="hidden" id="checkModal" value="">
                        <div class="row">
                            ...
                            <div class="col-md-12 d-block" id="product_label">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('product_name') ? 'is-invalid' : '' }}" style="text-transform: capitalize" type="text" name="product_name" id="product_name" value="{{ old('name', '') }}" required>
                                ...
                                <div class="col-md-12 d-block" id="service_label">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('service_name') ? 'is-invalid' : '' }}" style="text-transform: capitalize" type="text" name="service_name" id="service_name" value="{{ old('name', '') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <label class="required">{{ trans('cruds.product.fields.unit') }}</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control w-100 select2 {{ $errors->has('categories') ? 'is-invalid' : '' }}" name="categories" id="categories" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required" for="sales_price">{{ trans('cruds.product.fields.rate_exclusive') }}</label>
                                    <input class="form-control {{ $errors->has('rate_exclusive') ? 'is-invalid' : '' }}" type="number" name="sales_price" id="sales_price" value="{{ old('sales_price', '') }}" step="0.01" required>
                                    @if($errors->has('rate_exclusive'))
                                        <span class="text-danger">{{ $errors->first('rate_exclusive') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.rate_exclusive_helper') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required">{{ trans('cruds.product.fields.gst') }}</label>
  ...
  <div class="modal fade" id="productReviewModal" aria-labelledby="exampleModalLabel2" aria-hidden="true">
    <div class="modal-dialog modal-xl productModal-dialog" style="">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel2">Review Product</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
        <form method="" enctype="multipart/form-data" id="product_review_form">
            <input type="hidden" id="checkModal" value="">
                <div class="">
                    <h5>Product/Service Information Review</h5>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="hidden" id="product_review_main_id" value="">
                                    <label class="required">{{ trans('cruds.product.fields.item_type') }}</label>
                                    @foreach(App\Models\Product::ITEM_TYPE_RADIO as $key => $label)
                                        <div class="form-check {{ $errors->has('item_type') ? 'is-invalid' : '' }}">
                                            <input class="form-check-input" type="radio" id="item_review_type_{{ $key }}" name="item_review_type" value="{{ $key }}" {{ old('item_type', '') === (string) $key ? 'checked' : '' }} required>
                                            <label class="form-check-label" for="item_review_type_{{ $key }}">{{ $label }}</label>
                                        </div>
                                    @endforeach
                                    @if($errors->has('item_type'))
                                        <span class="text-danger">{{ $errors->first('item_type') }}</span>
                            ...
                            <div class="col-md-12 d-block" id="product_review_label">
                                <div class="form-group">
                                    <label class="required" for="product_review_name">Product Name</label>
                                    <input class="form-control {{ $errors->has('product_name') ? 'is-invalid' : '' }}" style="text-transform: capitalize" type="text" name="product_name" id="product_review_name" value="{{ old('name', '') }}">
                                    @if($errors->has('product_name'))
                                        <span class="text-danger">{{ $errors->first('product_name') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.name_helper') }}</span>
                                ...
                                <div class="col-md-12 d-block" id="service_review_label">
                                    <div class="form-group">
                                        <label class="required" for="service_review_name">Service Name</label>
                                        <input class="form-control {{ $errors->has('service_name') ? 'is-invalid' : '' }}" style="text-transform: capitalize" type="text" name="service_name" id="service_review_name" value="{{ old('name', '') }}" >
                                        @if($errors->has('service_name'))
                                            <span class="text-danger">{{ $errors->first('service_name') }}</span>
                                        @endif
                                        <span class="help-block">{{ trans('cruds.product.fields.name_helper') }}</span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description_review" required>{{ old('description') }}</textarea>
                                    @if($errors->has('description'))
                                        <span class="text-danger">{{ $errors->first('description') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.description_helper') }}</span>
                            ...
                            <div class="col-md-12 d-block" id="hsn_review_label">
                                <div class="form-group">
                                    <label class="required" for="hsn">HSN</label>
                                    <input class="form-control {{ $errors->has('hsn') ? 'is-invalid' : '' }}" type="text" name="hsn" id="hsn_review" value="{{ old('hsn', '') }}">
                                    @if($errors->has('hsn'))
                                        <span class="text-danger">{{ $errors->first('hsn') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.hsn_helper') }}</span>
                            ...
                            <div class="col-md-12 d-none" id="sac_review_label">
                                <div class="form-group">
                                    <label class="required" for="sac">SAC</label>
                                    <input class="form-control {{ $errors->has('sac') ? 'is-invalid' : '' }}" type="text" name="sac" id="sac_review" value="{{ old('sac', '') }}">
                                    @if($errors->has('sac'))
                                        <span class="text-danger">{{ $errors->first('sac') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.hsn_helper') }}</span>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <label class="required">{{ trans('cruds.product.fields.unit') }}</label>
                                    <select class="form-control {{ $errors->has('unit') ? 'is-invalid' : '' }}" name="unit" id="unit_review" required>
                                        <option value disabled {{ old('unit', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Product::UNIT_SELECT as $key => $label)
                                            <option value="{{ $key }}" {{ old('unit', '') === (string) $key ? 'selected' : '' }}>{{ $key.' - '.$label }}</option>
                                        @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control w-100 select2 {{ $errors->has('categories') ? 'is-invalid' : '' }}" name="categories" id="categories_review" required>
                                        @foreach($categories as $id => $category)
                                            <option value="{{ $id }}" {{ old('categories') == $id ? 'selected' : '' }}>{{ $category }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required" for="sales_price">{{ trans('cruds.product.fields.rate_exclusive') }}</label>
                                    <input class="form-control {{ $errors->has('rate_exclusive') ? 'is-invalid' : '' }}" type="number" name="sales_price" id="sales_price_review" value="{{ old('sales_price', '') }}" step="0.01" required>
                                    @if($errors->has('rate_exclusive'))
                                        <span class="text-danger">{{ $errors->first('rate_exclusive') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.rate_exclusive_helper') }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required">{{ trans('cruds.product.fields.gst') }}</label>
                                    <select class="form-control {{ $errors->has('gst') ? 'is-invalid' : '' }}" name="gst" id="gst_review" required>
                                        <option value disabled {{ old('gst', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Product::GST_SELECT as $key => $label)
                                            <option value="{{ $key }}" {{ old('gst', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                        ...
                        {{-- <div class="form-check mb-2">
                            <div class="form-group">
                                ...
                                @foreach(App\Models\Product::TAX_TYPE_RADIO as $key => $label)
                                    <div class="form-check {{ $errors->has('tax_type') ? 'is-invalid' : '' }}">
                                        <input class="form-check-input" type="radio" id="tax_review_type_{{ $key }}" name="tax_type" value="{{ $key }}" {{ old('tax_type', '') === (string) $key ? 'checked' : '' }}>
                                        <label class="form-check-label" for="tax_review_type_{{ $key }}">{{ $label }}</label>
                                    </div>
                                @endforeach
                                @if($errors->has('tax_type'))
                                    <span class="text-danger">{{ $errors->first('tax_type') }}</span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="cess">{{ trans('cruds.product.fields.cess') }}</label>
                                    <input class="form-control {{ $errors->has('cess') ? 'is-invalid' : '' }}" type="number" name="cess" id="cess_review" value="{{ old('cess', '') }}" step="1">
                                    @if($errors->has('cess'))
                                        <span class="text-danger">{{ $errors->first('cess') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.cess_helper') }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ trans('cruds.product.fields.cess_type') }}</label>
                                    <select class="form-control {{ $errors->has('cess_type') ? 'is-invalid' : '' }}" name="cess_review_type" id="cess_type">
                                        <option value disabled {{ old('cess_type', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Product::CESS_TYPE_SELECT as $key => $label)
                                            <option value="{{ $key }}" {{ old('cess_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="purchase_price">{{ trans('cruds.product.fields.purchase_price') }}</label>
                                    <input class="form-control {{ $errors->has('purchase_price') ? 'is-invalid' : '' }}" type="number" name="purchase_price" id="purchase_price_review" value="{{ old('purchase_price', '') }}" step="0.01">
                                    @if($errors->has('purchase_price'))
                                        <span class="text-danger">{{ $errors->first('purchase_price') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.purchase_price_helper') }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ trans('cruds.product.fields.price_type') }}</label>
                                    <select class="form-control {{ $errors->has('price_type') ? 'is-invalid' : '' }}" name="price_type" id="price_type_review">
                                        <option value disabled {{ old('price_type', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Product::PRICE_TYPE_SELECT as $key => $label)
                                            <option value="{{ $key }}" {{ old('price_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wholesale_price">{{ trans('cruds.product.fields.wholesale_price') }}</label>
                                    <input class="form-control {{ $errors->has('wholesale_price') ? 'is-invalid' : '' }}" type="number" name="wholesale_price" id="wholesale_price_review" value="{{ old('wholesale_price', '') }}" step="0.01">
                                    @if($errors->has('wholesale_price'))
                                        <span class="text-danger">{{ $errors->first('wholesale_price') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.wholesale_price_helper') }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="item_code">{{ trans('cruds.product.fields.item_code') }}</label>
                                    <input class="form-control {{ $errors->has('item_code') ? 'is-invalid' : '' }}" type="text" name="item_code" id="item_code_review" value="{{ old('item_code', '') }}">
                                    @if($errors->has('item_code'))
                                        <span class="text-danger">{{ $errors->first('item_code') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.product.fields.item_code_helper') }}</span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required">{{ trans('cruds.product.fields.income_account_type') }}</label>
                                    <select class="form-control {{ $errors->has('income_account_type') ? 'is-invalid' : '' }}" name="income_account_type" id="income_account_type_review" required>
                                        <option value disabled {{ old('income_account_type', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Product::INCOME_ACCOUNT_TYPE_SELECT as $key => $label)
                                            <option value="{{ $key }}" {{ old('income_account_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required">{{ trans('cruds.product.fields.account_group') }}</label>
                                    <select class="form-control {{ $errors->has('account_group') ? 'is-invalid' : '' }}" name="account_group" id="account_group_review" required>
                                        <option value disabled {{ old('account_group', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                        @foreach(App\Models\Product::ACCOUNT_GROUP_SELECT as $key => $label)
                                            <option value="{{ $key }}" {{ old('account_group', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required d-block" for="account_type_id">{{ trans('cruds.product.fields.account_type') }}</label>
                                    <select class="form-control select2 {{ $errors->has('account_type') ? 'is-invalid' : '' }}" name="account_type_id" id="account_type_id_review" required>
                                        @foreach($account_types as $id => $entry)
                                            <option value="{{ $id }}" {{ old('account_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="required d-block" for="account_name_id">{{ trans('cruds.product.fields.account_name') }}</label>
                                    <select class="form-control select2 {{ $errors->has('account_name') ? 'is-invalid' : '' }}" name="account_name_id" id="account_name_id_review" required>
                                        @foreach($account_names as $id => $entry)
                                            <option value="{{ $id }}" {{ old('account_name_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="gridCheck_review">
                            <label class="form-check-label" for="gridCheck">
                            I sell this product/service to my customers.
                            </label>
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    <div class="form-check mb-2 font-weight-bold">
                        <input class="form-check-input" type="checkbox" name="product_approval_request" id="product_approval_request" value="1" {{ old('product_approval_request', 1) == 0 ? 'checked' : '' }}>
                        <label class="form-check-label"  for="product_approval_request">
                            Product Approved
                        </label>
                    </div>
                    <button type="submit" id="product_review_save" class="btn btn-primary">Save</button>
                </div>
            </form>
        </div>
      </div>
...
<script>
    $(window).on('load',function(){
        ...
        function calculateCgstSgst(_this){
            ...
            var gst_amt = parseFloat(rate*(current_tax_gst/100));
   ...
   $(document).ready(function(){
        ...
        $("#product_save").click(function(){
                                    ...
                                    $(".product_class").each(function() {
                                        if ($(this).attr('data-attr') ==
                                            dataValue) {
                                                ...
                                                $(this).parents('tr').find('#service_date').removeAttr('hidden');
            ...
            $(document).on('change', '.product_review_modal', function() {
                if ($(this).val() == 0) {
                 var dataValue = $(this).attr('data-attr')
                 $("#checkModal").val(dataValue);
                } else {}
...
<script>
    $(document).ready( function(){
        $.ajax({
            url: "{{ route('admin.invoices.edit-customfields',['type' => 'invoice_edit']) }}",
            type: 'get',
            ...
            success: function(data){
                if(data.length != null){
                    console.log(data);
                    $("#list_of_edit_custom_fields").html(data);
                }
            },
            error: function(error){
                console.log(error, 'err');
    ...
    $("#setting-btn").click(function() {
        ...
        $.ajax({
            url: "{{ route('admin.customfields.index',['type' => 'invoice_edit']) }}",
            type: 'get',
            data: {'company_id': $("#comp_id").val()},
            success: function(data) {
                if(data.length != null){
    ...
    $("#add_custom").click(function() {
        $.ajax({
                url: "{{ route('admin.invoices.count-customfields') }}",
                type: 'get',
                data: {'company_id': $("#comp_id").val()},
                success: function(data){
                    if(data.length != null){
                        if(data == 5){
                            sweetAlert("Alert!", "Custom Fields Creation Limit is Over", "warning");
                            $("#add_custom").hide();
                        }else{
    ...
    $("#all_sales_form_checker").click( function (){
    ...
    $("#edit_all_sales_form_checker").click( function (){
    ...
    $("#add_field_save").click(function(){
        console.log('company_id '+$("#comp_id").val());
        ...
        $.ajax({
                url: "{{ route('admin.customfields.store') }}",
                type: "post",
                headers: {
                    'X-CSRF-TOKEN': "{{ csrf_token() }}"
                },
                ...
                $("#show_of_edit_custom_fields").before("<div class='col-md-3' id='remove_"+data.id+"'><label>"+ data.custom_field_name +"</label>"+"<br><input type='text' class='form-control' id='custom_field_id["+data.id+"]' name='custom_field_id["+data.id+"]'></div>");
                    if(data.length != 0){
                        $.ajax({
                            url: "{{ route('admin.customfields.index',['type' => 'invoice_edit']) }}",
                            type: "get",
    ...
    $(document).on('click','#edit_custom_field',function(){
        ...
        var base_url = "{{env('APP_URL')}}"+ "/admin/customfields/" + edit_id +"/edit";
        $.ajax({
            url: base_url,
            type: 'get',
            data: {},
    ...
    $("#update_field_save").click( function(){
        ...
        console.log(edit_id);
        var base_url = "{{env('APP_URL')}}"+ "/admin/customfields/" + edit_id;
                    ...
                    console.log(data)
                        $.ajax({
                            ...
                            success: function(data) {
                                if(data.length != 0){
                                    $("#list_custom_fields").html(data);
                                    $("#remove_"+edit_id).find('label').text(custom_field_name);
                                }     
                            },
                            error: function(error) {
                                console.log(error, 'err');
    ...
    $(document).on('click','#remove_custom_field',function(){
        ...
        var base_url = "{{env('APP_URL')}}"+ "/admin/customfields/" + remove_id;
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.length != 0) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.invoices.get-customfields')}}",
                        type: "get",
                        data: {'company_id': $("#comp_id").val()},
                        success: function(data) {
                            if(data.length != 0){
                    ...
                    $.ajax({
                        url: "{{ route('admin.invoices.edit-customfields') }}",
                        type: 'get',
                        data: {'company_id': $("#comp_id").val(),
                                'invoice_id': $("#get_invoice_id").val()
                        },
    ...
    $(document).on('change','.inactive_field',function(){
        var inactive_id = $(this).attr('inactive_id');
        if($(this).is(':checked')){
            var custom_field_status = '1';
        }else{
            var custom_field_status = '0';            
        }
        $.ajax({
            url: "{{ route('admin.customfields.inactivefield') }}",
            type: 'post',
            headers: {
                'X-CSRF-TOKEN': "{{ csrf_token() }}"
            },
            ...
            success: function(data) {
                if(data.length != 0) {
                    ...
                    if(data != ""){
                        if(custom_field_status == 1){
                            $("#show_of_edit_custom_fields").before("<div class='col-md-3' id='remove_"+data.id+"'><label>"+ data.custom_field_name +"</label>"+"<br><input type='text' class='form-control' id='custom_field_id["+data.id+"]' name='custom_field_id["+data.id+"]'></div>");
                        }else{
                            document.getElementById('remove_'+data.id).remove();
                        }
                    }
                }
            },
    ...
    $(document).on('click','#include_inactive',function(){
        if($(this).is(':checked')){
            var include_inactive_status = '1';
        }else{
            var include_inactive_status = '0';            
        }
        $.ajax({
            url: "{{ route('admin.invoices.get-inactivecustomfields',['type' => 'invoice_edit']) }}",
            type: 'get',
            data: {'include_inactve_status' : include_inactive_status,
                'company_id': $("#comp_id").val() },
            success: function(data){
                if(data.length != 0){
                    $("#list_custom_fields").html(data);
...
<script>
     $("input[name='item_review_type']").change(function(){
            var item_type = $("input[name='item_review_type']:checked").val();
            $('input[name="item_review_type"]').attr('checked',false)
                if($(this).val() == 'G')
                {
                $(this).attr('checked',true)
                if ($("#hsn_review_label").hasClass("d-none")) {
                    $("#hsn_review_label").removeClass('d-none')
                    $("#hsn_review_label").addClass('d-block')
                }
                $("#sac_review_label").removeClass('d-block')
                $("#sac_review_label").addClass('d-none')

                if($("#product_review_label").hasClass("d-none")){
                    $("#product_review_label").removeClass('d-none')
                    $("#product_review_label").addClass('d-block')

                }
                $("#service_review_label").removeClass('d-block')
                $("#service_review_label").addClass('d-none')
                }else{
                $(this).attr('checked',true)
                $("#service_review_label").removeClass('d-none')
                $("#service_review_label").addClass('d-block')
                $("#product_review_label").removeClass('d-block')
                $("#product_review_label").addClass('d-none')
                
                $("#sac_review_label").removeClass('d-none')
                $("#sac_review_label").addClass('d-block')
                $("#hsn_review_label").removeClass('d-block')
                $("#hsn_review_label").addClass('d-none')
                }
               
        });

    $(".product_review_modal").click(function(){
        //get the product data here
        var review_product_id = $(this).attr('product_id');
        $.ajax({
            url: "{{ route('admin.invoices.get-review-products') }}",
            type: 'get',
            data: { 'product_id' : review_product_id,
                    'invoice_id': $("#review_invoice_id").val() },
            success: function(data){
                if(data.length != 0){
                   console.log(data);
                   $("#product_review_main_id").val(data.products.id);
                    if(data.products.item_type == "G"){
                        if ($("#hsn_review_label").hasClass("d-none")) {
                            $("#hsn_review_label").removeClass('d-none')
                            $("#hsn_review_label").addClass('d-block')
                            $("#hsn_review").attr('required',true);
                        }
                        $("#sac_review_label").removeClass('d-block')
                        $("#sac_review_label").addClass('d-none')
                        $("#sac_review").removeAttr('required');

                        if($("#product_review_label").hasClass("d-none")){
                            $("#product_review_label").removeClass('d-none')
                            $("#product_review_label").addClass('d-block')
                            $("#product_review_name").attr('required',true);
                        }
                        $("#service_review_label").removeClass('d-block')
                        $("#service_review_label").addClass('d-none')
                        $("#service_review_name").removeAttr('required')

                        //Here I set the Product Data
                        $("#item_review_type_G").attr('checked',true);
                        $("#product_review_name").val(data.products.name);
                        $("#hsn_review").val(data.products.hsn); 
                    }else{
                        $("#service_review_label").removeClass('d-none')                        
                        $("#service_review_label").addClass('d-block')
                        $("#service_review_name").attr('required',true);
                        $("#product_review_label").removeClass('d-block')
                        $("#product_review_label").addClass('d-none')
                        $("#product_review_name").removeAttr('required')
                
                        $("#sac_review_label").removeClass('d-none')
                        $("#sac_review_label").addClass('d-block')
                        $("#sac_review").attr('required',true);
                        $("#hsn_review_label").removeClass('d-block')
                        $("#hsn_review_label").addClass('d-none')
                        $("#hsn_review").removeAttr('required')

                        //Here I set the Product Data
                        $("#item_review_type_S").attr('checked',true);
                        $("#service_review_name").val(data.products.name);
                        $("#sac_review").val(data.products.hsn);
                    }
                    $("#description_review").val(data.products.description);
                    $("#unit_review").val(data.products.unit).trigger('change');
                    $("#categories_review").val(data.category.id).trigger('change');
                    if(data.products.sales_price == null){
                        $("#sales_price_review").val(data.invoice_details.rate);
                    }else{
                        $("#sales_price_review").val(data.products.sales_price);
                    }
                    if(data.products.gst == null){
                        $("#gst_review").val(data.invoice_details.tax).trigger('change');
                    }else{
                        $("#gst_review").val(data.products.gst).trigger('change');
                    }
                    if(data.products.tax_type == 'I'){
                        $("#tax_review_type_I").attr('checked',true);
                    }else{
                        $("#tax_review_type_E").attr('checked',true);
                    }
                    $("#cess_review").val(data.products.cess);
                    $("#cess_review_type").val(data.products.cess_type).trigger('change');
                    $("#purchase_price_review").val(data.products.purchase_price);
                    $("#price_type_review").val(data.products.price_type).trigger('change');
                    $("#wholesale_price_review").val(data.products.wholesale_price);
                    $("#item_code_review").val(data.products.item_code);
                    $("#income_account_type_review").val(data.products.income_account_type).trigger('change');
                    $("#account_group_review").val(data.products.account_group).trigger('change');
                    $("#account_type_id_review").val(data.products.account_type_id).trigger('change');
                    $("#account_name_id_review").val(data.products.account_name_id).trigger('change');
    ...
    $("#product_review_save").click(function(){
        $('#product_review_form').on('submit', function(e){
            e.preventDefault();
            var product_id = $("#product_review_main_id").val();
            if($("#product_approval_request").is(':checked')){
                var product_approval = '1'; 
            }else{
                var product_approval = '0';
            }
            var item_type = $("input[name='item_review_type']:checked").val();
            var hsn = $("#hsn_review").val()
            var sac = $("#sac_review").val()
            if(item_type == 'G')
            { 
                var product_name = $("#product_review_name").val()
                var hsn_code = hsn;
            }else{
                var product_name = $("#service_review_name").val()
                var hsn_code = sac;
            }
           
            var description = $("#description_review").val()

            var unit = $("#unit_review").val()
            var categories = $("#categories_review").val()
            var sales_price = $("#sales_price_review").val()
            var gst = $("#gst_review").val()
            var tax_type = $("input[name='tax_type_review']").val()
            var cess = $("#cess_review").val()
            var cess_type = $("#cess_review_type").val()
            var purchase_price = $("#purchase_price_review").val()
            var price_type = $("#price_type_review").val()
            var wholesale_price = $("#wholesale_price_review").val()
            var item_code = $("#item_code_review").val()
            var income_account_type = $("#income_account_type_review").val()
            var account_group = $("#account_group_review").val()
            var account_type_id = $("#account_type_id_review").val()
            var account_name_id = $("#account_name_id_review").val()
           
       
            $.ajax({
                url: "{{ route('admin.invoices.update-review-products') }}",
                type: "post",
                data: {
                        'product_id': product_id,
                        'product_approvel': product_approval,
                        'item_type':item_type,
                        'name' : product_name,
                        'description' : description,
                        'hsn' : hsn_code,
                ...
                $("#productReviewModal").modal('hide');
                    sweetAlert("Thanks", "Product successfully Updated/Approved!", "success");
                    if(data.length != 0){
                        console.log(data);
                        window.location.reload();
                        $(this).parents('tr').find('#hsn_sac').val(data.hsn);
                        $(this).parent('tr').find('#rate').val(data.sales_price);  
                        $(this).parents('tr').find('#tax_gst').val(data.gst).trigger('change');                      
                        $(this).parent('tr').find('#amount_inv').val(data.sales_price);                        
                        if(data.item_type == 'G'){
                        $(this).parents('tr').find('#service_date').hide();
                        }else{
                        $(this).parents('tr').find('#service_date').removeAttr('hidden');
