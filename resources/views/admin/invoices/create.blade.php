...
<form method="POST" action="{{ route("admin.invoices.store") }}" enctype="multipart/form-data">
    ...
    <div class="invoice-add">
        ...
        <div class="invoice-upper">
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="company_state_id">
            ...
            <div class="col-md-3">
                <div class="form-group">
                <label for="email" id="po_no_label">PO No.</label>
        ...
        <div class="row mt-2">
            <div class="col-md-3">
            <div class="form-group">
                <label for="address" id="billing_address_label">Billing Address</label>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="address" id="ship_address_label">Shipping Address</label>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" style="text-transform: uppercase" class="form-control" id="invoice_prefix" name="invoice_prefix">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        <tbody>
            ...
            <td style="width: 10%" class="service_date_td"> <input type="date" class="form-control" id="service_date" name="service_date[]"></td>
            <td style="width: 13%"><input type="text" class="form-control" id="hsn_sac" name="hsn_sac[]"></td>
            <td style="width: 7%"><input type="text" class="form-control quantity" id="quantity" name="quantity[]" value="1"></td>
            <td style="width: 13%"><input type="text" class="form-control rate" id="rate" name="rate[]" placeholder="0.00" required></td>
            <td style="width: 13%"><input type="text" class="form-control amount_inv" id="amount_inv" name="amount_inv[]" placeholder="0.00"></td>
            <td style="width: 20%">
                <select class="form-control py-0 tax_gst {{ $errors->has('tax_gst') ? 'is-invalid' : '' }}" name="tax_gst[]" id="tax_gst" >
                    ...
                    @foreach($gsts as $gst)
                        <option value="{{ $gst->gst }}" {{ old('tax_gst', '') === (string) $gst->gst ? 'selected' : '' }}>GST @ {{ $gst->gst }}%</option>
                    @endforeach
                </select>
            </td>
            <td><img src="{{ asset('img/delete.png')}}" id="delete_button" alt="" class="delete_invoice"></td>
          </tr>
        ...
        <div class="text-right pb-3 mt-5 d-flex justify-content-between">
            <a class="btn btn-warning" id="customization_btn" href="#">Customize</a>
            <div class="dropup">
                <span class="btn btn-info dropbtn">Templates</span>
            ...
            <form method="" action="" enctype="multipart/form-data" class="customer_info_form">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group col-lg-12" id="groupContent">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check ml-3">
                                        ...
                                        <input class="form-check-input" type="checkbox" value="1" id="same_as_bill" name="same_as_bill">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select
                                                class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}"
                                                name="city_id2" id="city_id2" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select
                                                class="form-control select2 w-100 {{ $errors->has('state') ? 'is-invalid' : '' }}"
                                                name="state_id2" id="state_id2" required>
                                                <option>Please Select</option>
                                            </select>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="" action="" enctype="multipart/form-data">
                        ...
                        <div class="">
                            <label>
                                <span><input id="edit_all_sales_form_checker" class="check_edit" type="checkbox"></span>
                                <span> All Sales forms</span>
                            </label>
                        </div>
                        <div class="">
  ...
  <div class="modal fade" id="groupModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ url('admin/invoices/create/group-add') }}" enctype="multipart/form-data">
              @csrf
                <div class="form-group">
...
>>>>>>> feature/invoice-create
        ...
        $('#company_id').change(function(){
            ...
            $.ajax({   
                url: "{{ route('admin.invoiceCustomize.allTemplateListing')}}",
                type: "get",
                data: {'company_id':$(this).val()},
                success: function(data) {
                    $('.dropup-content').append('<div class="d-flex justify-content-start content_color"><i class="bi bi-check-lg checked_template" id="checked_template" style="margin-right:7px"></i><span id="default_template" style="margin-left:7px">Standard</span></div>')
                    $.each(data, function(index, value) {
                    var temp_id = index;
                    var count = 0;
                    var url = "{{ route('admin.invoiceCustomizeTemplate.edit') }}";
                    url = url+'?'+'temp_id='+temp_id;
                    $('.dropup-content').append('<div class="d-flex justify-content-start content_color"><div class="selected_template_name" temp_id="'+temp_id+'"><span class="d-flex justify-content-between"><span style="margin-left:7px">'+value+'</span></div><a href="'+url+'" id="template_edit"><i class="bi bi-pencil-fill" style="margin-left:54px "></i></a><i class="template_delete bi bi-trash "id="template_delete" style="margin-left:8px" temp_id="'+temp_id+'"></i></span></div>')
                    })
                },
                error: function(error) { 
                    console.log(error, 'err');
            ...
            $(document).on('click','.selected_template_name',function(){
                var template_id= $(this).attr('temp_id');
                $('#template_id').val(template_id);
                $('.checked_template').addClass('d-none');
                $(this).before('<i class="bi bi-check-lg checked_template" style="margin-right:7px"></i>');
            });
            $(document).on('click','#default_template',function(){
                $('#template_id').val('0');
                $('.checked_template').remove();
                $(this).before('<i class="bi bi-check-lg checked_template" style="margin-right:7px"></i>');
            });
...
<script>
    $("#setting-btn").click(function() {
        if($("#company_id").val()==''){
            sweetAlert("Alert!!", "Please Select Company First!!", "error"); 
        }else{
        $(".manage-invoice-bg").addClass('active');
        $.ajax({
            url: "{{ route('admin.customfields.index',['type' => 'invoice_create']) }}",
            type: 'get',
    ...
    $("#add_custom").click(function() {
        if($('#company_id').val() == ''){
            alert('Firstly Please Select the Company');
            $("#addCustomFieldModel").attr('disabled',true);
        }else{
    ...
    $("#add_field_save").click(function(){
        ...
        $.ajax({
                ...
                $("#show_custom_fields").before("<div class='col-md-3' id='remove_"+data.id+"'><label>"+ data.custom_field_name +"</label>"+"<br><input type='text' class='form-control' id='custom_field_id["+data.id+"]' name='custom_field_id["+data.id+"]'></div>");
                    if(data.length != 0){
                        $.ajax({
                            url: "{{ route('admin.customfields.index',['type' => 'invoice_create']) }}",
                            type: "get",
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.length != 0) {
                    ...
                    if($("#edit_invoice_request_checker"||"#edit_sales_receipt_checker"||"#edit_estimate_checker"||"#edit_credit_note_checker"||"#edit_refund_receipt_checker"||"#edit_purchase_order_checker").is(':checked')){
                        $("#edit_all_sales_form_checker").attr('checked',true);
                    }else{
                        $("#edit_all_sales_form_checker").attr('checked',false); 
                    }
    ...
    $(document).on('click','#include_inactive',function(){
        ...
        $.ajax({
            url: "{{ route('admin.invoices.get-inactivecustomfields',['type' => 'invoice_create']) }}",
            type: 'get',
...
$("#haspono").change( function (){
    ...
    $("#customization_btn").click(function() {
        var comp_id = $('#company_id').val();
        if(comp_id == ''){
        url ='#';
        $("#customization_btn").attr("href", url);
        sweetAlert("Alert!!", "Please Select Company First To Create Template!", "error"); 
        }else{
        var url = "{{ route('admin.invoice-customize.index') }}";
        url = url+'?'+'comp_id='+comp_id;
        $("#customization_btn").attr("href", url);
        }
    ...
    $(document).on('click','.template_delete',function(){
        var temp_id =  $(this).attr("temp_id"); 
            ...
            $(document).on('click','.confirm',function(){
               $.ajax({
                        url: "{{ route('admin.invoiceCustomizeTemplate.destroy') }}",
                        type: "get",
                        data: {
                            'temp_id': temp_id
                        },
