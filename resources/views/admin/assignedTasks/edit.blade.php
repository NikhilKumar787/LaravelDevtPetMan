...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assigned-tasks.update", [$assignedTask->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $assignedTask->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hours_estimation') ? 'is-invalid' : '' }}" type="text" name="hours_estimation" id="hours_estimation" value="{{ old('hours_estimation', $assignedTask->hours_estimation) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_approved') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_approved" id="is_approved" value="1" {{ $assignedTask->is_approved || old('is_approved', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('target_date') ? 'is-invalid' : '' }}" type="text" name="target_date" id="target_date" value="{{ old('target_date', $assignedTask->target_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('completed_date') ? 'is-invalid' : '' }}" type="text" name="completed_date" id="completed_date" value="{{ old('completed_date', $assignedTask->completed_date) }}">
