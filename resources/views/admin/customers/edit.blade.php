...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.update", [$customer->id]) }}" enctype="multipart/form-data">
            ...
            <input class="form-check-input" type="checkbox" name="customer_approval" id="customer_approval" value="1" {{ old('customer_approval', 1) == 0 ? 'checked' : '' }}>
              <label class="form-check-label"  for="customer_approval">
                Customer Approved
              </label>
            </div>
            @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="url" name="website" id="website" value="{{ old('website', $customer->website) }}">
