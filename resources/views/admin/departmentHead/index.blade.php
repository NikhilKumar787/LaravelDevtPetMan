...
{{-- @can('department_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.department-head.create',['company'=> $company_id]) }}">
                {{ trans('global.add') }} {{ trans('cruds.department.fields.department_head') }}
            </a>
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.department.fields.department_head') }} {{ trans('global.list') }}
    </div>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.department-head.index',['comp_id'=> $company_id]) }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'department_name', name: 'department_name.name' },
{ data: 'department_head', name: 'department_head.name' },
