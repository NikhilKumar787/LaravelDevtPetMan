    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-addresses.update", [$userAddress->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('addressline_2') ? 'is-invalid' : '' }}" type="text" name="addressline_2" id="addressline_2" value="{{ old('addressline_2', $userAddress->addressline_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $userAddress->state) }}" required>
                @if($errors->has('state'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uuid') ? 'is-invalid' : '' }}" type="text" name="uuid" id="uuid" value="{{ old('uuid', $userAddress->uuid) }}">
                @if($errors->has('uuid'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('same_as') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="same_as" id="same_as" value="1" {{ $userAddress->same_as || old('same_as', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('default_address') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="default_address" id="default_address" value="1" {{ $userAddress->default_address || old('default_address', 0) === 1 ? 'checked' : '' }}>
