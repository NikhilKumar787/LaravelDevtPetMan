...
@section('content')
    <div class="bg-white p-3">
     <h5> {{ trans('global.create') }} {{ trans('cruds.company.title_singular') }}</h5>
        <div class="">
            <form method="POST" action="{{ route('admin.companies.store') }}" enctype="multipart/form-data" id="companyForm">
                ...
                <div class="bg-light p-3 mb-3">
                    ...
                    <div class="form-row mt-3">
                        <div class="form-group col-9">
                            ...
                            <select
                                ...
                                @foreach ($companyTypes as $id => $entry)
                                    <option value="{{ $id }}" {{ old('company_type_id') == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="owner_limit" id="owner_limit" class="form-control py-0 owner_limit" required >
                        </div>
                        <div class="form-group col-12">
                            <div class="row company-user-div align-items-end justify-content-between">
                                <div class="col-md-5">
                                    <label for="">Organization Head</label>
                                ...
                                <div class="col-md-2 clone-user-div text-right">
                                    <button class="btn btn-success clone-user-btn btn-block" type="button">Add+</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3" id="company_name_container">
                            ...
                            <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text"
                                name="company_name" id="company_name" value="{{ old('business_entity', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('gstin') ? 'is-invalid' : '' }}" type="text"
                                name="gstin" id="gstin" value="{{ old('gstin', '') }}">
                            @if ($errors->has('gstin'))
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('address_line_1') ? 'is-invalid' : '' }}" type="text"
                                name="address_line_1" id="address_line_1" value="{{ old('address_line_1', '') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('address_line_2') ? 'is-invalid' : '' }}" type="text"
                                name="address_line_2" id="address_line_2" value="{{ old('address_line_2', '') }}" required>
                        ...
                        <div class="form-group col-md-3">
                            <label class="required"
                                for="pin_code">{{ trans('cruds.company.fields.pin_code') }}</label>
                            <input class="form-control {{ $errors->has('pin_code') ? 'is-invalid' : '' }}" type="text"
                                name="pin_code" id="pin_code" value="{{ old('pin_code', '') }}" required>
                        </div>
                        <div class="form-group col-md-3" id="cin_container">
                            <label for="cin">CIN</label>
                            <input class="form-control {{ $errors->has('cin') ? 'is-invalid' : '' }}" type="text"
                                name="cin" id="cin" value="{{ old('cin', '') }}">
                            @if ($errors->has('cin'))
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="team_limit" id="team_limit" class="form-control py-0 team_limit" required >
                        </div> 
                ...
                <div class="bg-light p-3 mb-3">
                    ...
                    <div class="form-row mt-3">
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('username_for_pan_tan') ? 'is-invalid' : '' }}"
                                type="text" name="username_for_pan_tan" id="username_for_pan_tan"
                                value="{{ old('username_for_pan_tan', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('username_for_gst_vat_icegate_dgft') ? 'is-invalid' : '' }}"
                                type="text" name="username_for_gst_vat_icegate_dgft" id="username_for_gst_vat_icegate_dgft"
                                value="{{ old('username_for_gst_vat_icegate_dgft', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('password_for_gst_vat_icegate_dgft') ? 'is-invalid' : '' }}"
                                type="text" name="password_for_gst_vat_icegate_dgft" id="password_for_gst_vat_icegate_dgft"
                                value="{{ old('password_for_gst_vat_icegate_dgft', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('username_for_e_way_e_invoicing') ? 'is-invalid' : '' }}"
                                type="text" name="username_for_e_way_e_invoicing" id="username_for_e_way_e_invoicing"
                                value="{{ old('username_for_e_way_e_invoicing', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('password_for_e_way_e_invoicing') ? 'is-invalid' : '' }}"
                                type="text" name="password_for_e_way_e_invoicing" id="password_for_e_way_e_invoicing"
                                value="{{ old('password_for_e_way_e_invoicing', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('username_for_traces') ? 'is-invalid' : '' }}"
                                type="text" name="username_for_traces" id="username_for_traces"
                                value="{{ old('username_for_traces', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('password_for_traces') ? 'is-invalid' : '' }}"
                                type="text" name="password_for_traces" id="password_for_traces"
                                value="{{ old('password_for_traces', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input
                                class="form-control {{ $errors->has('username_for_pf_esi_and_other_labour_law') ? 'is-invalid' : '' }}"
                                type="text" name="username_for_pf_esi_and_other_labour_law"
                                id="username_for_pf_esi_and_other_labour_law"
                                value="{{ old('username_for_pf_esi_and_other_labour_law', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input
                                class="form-control {{ $errors->has('password_for_pf_esi_and_other_labour_law') ? 'is-invalid' : '' }}"
                                type="text" name="password_for_pf_esi_and_other_labour_law"
                                id="password_for_pf_esi_and_other_labour_law"
                                value="{{ old('password_for_pf_esi_and_other_labour_law', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('username_for_reporting_portal') ? 'is-invalid' : '' }}"
                                type="text" name="username_for_reporting_portal" id="username_for_reporting_portal"
                                value="{{ old('username_for_reporting_portal', '') }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('password_for_reporting_portal') ? 'is-invalid' : '' }}"
                                type="text" name="password_for_reporting_portal" id="password_for_reporting_portal"
                                value="{{ old('password_for_reporting_portal', '') }}">
                ...
                <div class="bg-light p-3 mb-3">
                    <h6 class="form-sub-heading">Business Logos & Certificate</h6>
                    <div class="form-row">
                    <div class="form-group col-md-3">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow-y: scroll;height:600px">
                    ...
                    <form autocomplete="none" method="" action="" enctype="multipart/form-data" >
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}"
                                            type="email" name="email" id="email" value="{{ old('email') }}" autocomplete="none">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="required"
