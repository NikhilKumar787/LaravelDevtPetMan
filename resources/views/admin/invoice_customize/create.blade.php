    ...
    <div class="row">
                ...
                <ul class="nav nav-pills mb-3 custom-invoice-ul" id="pills-tab" role="tablist">
                  ...
                  <div class="tab-content" id="pills-tabContent">
                    <div class="form-group">
                        <input type="hidden" id="template_logo_alignment">
                        <input type="hidden" id="selected_template_no">
                        <input type="hidden" id="selected_template_color_code">
                        <input type="hidden" id="selected_template_font">
                        <input type="hidden" id="selected_company_id" value="{{$company_id}}">
                    </div>
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <label for="exampleInputEmail1">Template name</label>
                        <div class="form-group">
                            <input type="text" class="form-control" id="template_name" aria-describedby="emailHelp" readonly>
                        </div>
                        ...
                        <button class="btn btn-primary" id="apply_change" type="submit">Apply Change</button>
                    </div>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="header_content d-none">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="" id="unhide_shipping_address">
                                        <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" name="check_shipping_address" id="check_shipping_address" value="1" {{ old('check_shipping_address', 1) == 0 ? 'checked' : '' }} checked>
                                        <label for="shipping_address" style="margin-left: 20px">Shipping Address</label>
                                    </div>
                                    <div class="" id="unhide_terms">
                                        <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" name="check_terms" id="check_terms" value="1" {{ old('check_due_date', 1) == 0 ? 'checked' : '' }} checked>
                                        <label for="terms" style="margin-left: 20px">Terms</label>
                                    </div>
                                    <div class="" id="unhide_due_date">
                                        <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" name="check_due_date" id="check_due_date" value="1" {{ old('check_due_date', 1) == 0 ? 'checked' : '' }} checked>
                        ...
                        <div class="center_content">
                            ...
                            <div class="hidden_center_click d-none" style="margin-top: 20px;">
                                ...
                                <hr>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" name="date" id="check_product_date" value="1" {{ old('check_product_date', 1) == 0 ? 'checked' : '' }}>
                                    <label for="product_date" style="margin-left: 20px; font-size:15px;">Date</label>
                                </div><hr>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" id="check_product_service" value="1" {{ old('check_product_service', 1) == 0 ? 'checked' : '' }} checked>
                                    <label for="product_service" style="margin-left: 20px; font-size:15px;">Product/Service</label>
                                    <div class="" id="">
                                        <input class="form-check-input" style="margin-left: 22px" type="checkbox" id="check_incl_des_here" value="1" {{ old('check_incl_des_here', 1) == 0 ? 'checked' : '' }}>
                                        <label for="incl_des_here" style="margin-left: 40px; font-size:11px;">Include description here</label>
                                    </div>
                                </div><hr>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox"  id="check_product_description" value="1" {{ old('check_product_description', 1) == 0 ? 'checked' : '' }} checked>
                                    <label for="description" style="margin-left: 20px; font-size:15px;">Description</label>
                                    <div class="" id="">
                                        <input class="form-check-input" style="margin-left: 22px" type="checkbox" id="check_incl_qua_rate" value="1" {{ old('check_incl_qua_rate', 1) == 0 ? 'checked' : '' }}>
                                        <label for="incl_des_here" style="margin-left: 40px; font-size:11px;">Include Quantity and Rate</label>
                                    </div>
                                </div><hr>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" id="check_product_quantity" value="1" {{ old('check_product_quantity', 1) == 0 ? 'checked' : '' }} checked>
                                    <label for="quantity" style="margin-left: 20px; font-size:15px;">Quantity</label>
                                </div><hr>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" id="check_product_rate" value="1" {{ old('check_product_rate', 1) == 0 ? 'checked' : '' }} checked>
                                    <label for="rate" style="margin-left: 20px; font-size:15px;">Rate</label>
                                </div><hr>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" id="check_product_amount" value="1" {{ old('check_product_amount', 1) == 0 ? 'checked' : '' }} checked>
                                    <label for="amount" style="margin-left: 20px; font-size:15px;">Amount</label>
                                </div><hr>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" id="check_product_sku" value="1" {{ old('check_product_sku', 1) == 0 ? 'checked' : '' }}>
                        ...
                        <div class="footer_content">
                            ...
                            <div class="hidden_footer_click d-none" style="margin-top: 15px;">
                                <span>Display</span>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" id="check_product_discount" value="1" {{ old('check_product_discount', 1) == 0 ? 'checked' : '' }}>
                                    <label for="discount" style="margin-left: 20px; font-size:12px;">Discount</label>
                                </div>
                                <div class="" id="">
                                    <input class="form-check-input" style="margin-left: 0.5px" type="checkbox" id="check_product_deposit" value="1" {{ old('check_product_deposit', 1) == 0 ? 'checked' : '' }}>
                            ...
                            <div class="hidden_footer_click d-none" style="margin-top: 15px;">
                                ...
                                <div class="form-group" id="">
                                    <textarea class="form-control" style="width: 100%" id="message_customer_invoices" cols="30" rows="10" placeholder="We appreciate your business and look forward to helping you again soon."></textarea>
                                </div>
                                <div class="" style="margin-left: 500px;margin-top: 100px;" id="unhide_save_btn">
                                    <button class="btn btn-success save_header_content_btn" id="save_header_content_btn">Done</button>
                                </div> 
                            </div>
                        </div>    
                    </div>
                                ...
                                <span class="email_cursor" id="standard_email"><i class="bi bi-caret-down-fill right_arrow_standard"></i><i class="bi bi-caret-right-fill down_arrow_standard d-none"></i> Standard email</span><br>
                                    <div class="hide_email_standard">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="email_subject" id="email_subject" value="Invoice [Invoice No.] from {{$company->company_name}}">
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="form-group" id="" style="margin-top:10px">
                                            <textarea class="form-control" style="width: 100%" id="message_standard_email" cols="61" rows="8" placeholder="We appreciate your business. Please find your invoice details here. Feel free to contact us if you have any questions.">We appreciate your business. Please find your invoice details here. Feel free to contact us if you have any questions.</textarea>
                                        </div>
                                        </div><hr>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            <label for="">Subject</label>
                                            <input class="form-control" type="text" name="email_subject" id="email_reminder_subject" value="Reminder: Your payment to {{$company->company_name}} Inc is due">
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-3" id="" style="margin-top: 10px">
                                           ...
                                           <span style="font-weight: bolder">Message to customer</span>
                                            <div class="form-group" id="" style="margin-top:10px">
                                                <textarea class="form-control" style="width: 100%" id="message_reminder_email" cols="61" rows="8">We're sending a reminder to let you know that invoice [Invoice No.] has not been paid. If you already paid this invoice or have any questions, let us know!</textarea>
                                        </div>
                                   </div>     
                                </div>
                            </div>
        ...
        <div class="col-md-6 d-none" id="email_content" style="border-style: ridge;">
            <div class="" >
                ...
                <span >Subject: <span class="subject_email">Invoice 12345 from {{$company->company_name}}</span><span class="subject_reminder_email d-none"> Reminder: Your payment to {{$company->company_name}} is due</span></span><br>
                ...
                <div class="emailer" style="padding: 40px;">
                    ...
                    <div class="" style="margin-top: 10px">
                        <p class="hide_greeting"><span class="dear_greeting">Dear</span><span class="to_greeting d-none">To</span> [customer <span class="first_last_name d-none">first name last name</span> <span class="title_last_name d-none"> title last name</span> <span class="first_name d-none">first name</span> <span class="company_name d-none">company name</span> <span class="display_name d-none">display name</span> <span class="full_name">full name</span>]</p>
                        <p class="standard_email_message">We appreciate your business. Please find your invoice details here. Feel free to contact us if you have any questions.</p>
                        <p class="reminder_email_message d-none">We're sending a reminder to let you know that invoice 12345 has not been paid. If you already paid this invoice or have any questions, let us know!</p>
...
<script>
    ...
    $(document).ready( function(){ 
        ...
        var template_name_by_comp = $('#selected_company_id').val(); 
        $('#template_name').val('template-'+template_name_by_comp+'('+x+')');
        $('#first_active').addClass('active');
        $('#template_logo_alignment').val('right');
        ...
        $("#apply_change").click(function(){
            ...
            var template_logo_alignment = $('#template_logo_alignment').val();

            $.ajax({
                url: "{{ route('admin.invoiceCustomize.store')}}",
                type: "post",
                data: {
                    '_token':$('input[name="_token"]').val(),
                    'template_name':template_name,
                    'temp_no':temp_no,
                    'logo_alignment':template_logo_alignment,
                ...
                success: function(data) {
                if(data.length != 0){
                   sweetAlert("Thanks", "Template Successfully Saved!", "success"); 
                }
                },
                error: function(error) {
                    console.log(error, 'err');
        ...
        $("#check_email").change( function (){
            if($("#check_email").is(':checked')){
                $(".owner_email").removeClass('d-none');
            }else{
                $(".owner_email").addClass('d-none');
            }
        }); 
        ...
        $(document).on('click', '#save_header_content_btn', function() {
            if($("#check_business_name").is(':checked')){
         ...
         $.ajax({
            url: "{{ route('admin.invoiceCustomize.save-template-content') }}",
            type: "post",
            data: {
            '_token': $('input[name="_token"]').val(),
            'company_id':comp_id,
        ...
        $("#check_product_date").change( function (){
            if($("#check_product_date").is(':checked')){
                $(".product_date").removeClass('d-none');
            }else{
                $(".product_date").addClass('d-none');
            }
        }); 
        ...
        $("#check_product_amount").change( function (){
            if($("#check_product_amount").is(':checked')){
                $(".product_amount").removeClass('d-none');
            }else{
                $(".product_amount").addClass('d-none');
            }
        });
        ...
        $("#check_product_discount").change( function (){
            if($("#check_product_discount").is(':checked')){
                $(".product_discount").removeClass('d-none');
            }else{
                $(".product_discount").addClass('d-none');
            }
        }); 

        $("#check_product_deposit").change( function (){
            if($("#check_product_deposit").is(':checked')){
                $(".product_deposit").removeClass('d-none');
            }else{
                $(".product_deposit").addClass('d-none');
            }
        }); 
        ...
        $("#check_standard_greeting").change( function (){
            if($("#check_standard_greeting").is(':checked')){
                $('.hide_greeting').removeClass('d-none');
            }else{
                $('.hide_greeting').addClass('d-none');
            }
        }); 
        ...
        $('#choose_standard_greeting').change( function(){
            ...
            if(choose_standard_greeting == 1){
                $('.dear_greeting').addClass('d-none');
                $('.to_greeting').addClass('d-none'); 
            }else if(choose_standard_greeting == 2){
                $('.to_greeting').removeClass('d-none');
                $('.dear_greeting').addClass('d-none'); 
            }else if(choose_standard_greeting == 3){
                $('.dear_greeting').removeClass('d-none'); 
                $('.to_greeting').addClass('d-none');
            }
        });
        ...
        $('#choose_standard_greeting_name').change( function(){
            ...
            if(greeting_name == 1){
                ...
                $('.title_last_name').addClass('d-none');
                $('.first_name').addClass('d-none');
                $('.company_name').addClass('d-none'); 
                $('.display_name').addClass('d-none');
                $('.first_last_name').removeClass('d-none'); 
                ...
                $('.company_name').addClass('d-none'); 
                $('.display_name').addClass('d-none');
                $('.title_last_name').removeClass('d-none'); 
                ...
                $('.first_name').addClass('d-none');
                $('.company_name').addClass('d-none'); 
                $('.display_name').removeClass('d-none');
            }
        });
