...
@can('terms_andcondition_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.terms-andconditions.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-TermsAndcondition">
            <thead>
                <tr>
                    <th width="10">
...
@can('terms_andcondition_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.terms-andconditions.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.terms-andconditions.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-TermsAndcondition').DataTable(dtOverrideGlobals);
