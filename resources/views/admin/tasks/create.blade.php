    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tasks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control department_id select2 {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department_id" id="department_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control funcation_id select2 {{ $errors->has('department') ? 'is-invalid' : '' }}" name="funcation_id" id="funcation_id" required>
...
$('.department_id').on('change', function() {
            ...
            $.get('{{ route('admin.tasks.get-funcation') }}', {
                    "type_id": company_id
                },
                function(data) {
                    if (data) {
