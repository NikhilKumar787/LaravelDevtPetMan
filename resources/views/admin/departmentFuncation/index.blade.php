...
@can('department_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.department_funcations.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.department.fields.department_funcation') }}
            </a>
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.department.fields.department_funcation') }} {{ trans('global.list') }}
    </div>
        ...
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Department">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.department.fields.funcation_name') }}
                    </th>
                    <th>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.department_funcations.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'funcation_name', name: 'name' },
