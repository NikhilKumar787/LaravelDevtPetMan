...
<div class="card">
    <div class="card-header">
        {{ trans('global.show') }} {{ trans('cruds.department.fields.department_funcation') }}
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.department_funcations.index') }}">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $departmentFuncation->funcation_name }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ $departmentFuncation->department->name ?? '' }}
                        </td>
                    </tr>
                </tbody>
            </table>
