            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ isset($subTask->department->name) ? $subTask->department->name : '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ isset($subTask->task->name) ?$subTask->task->name : '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ isset($subTask->company->company_name) ? $subTask->company->company_name : '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ isset($subTask->name) ? $subTask->name : ''  }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ isset($subTask->description) ? $subTask->description : '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ isset($subTask->assigned_employee->name) ? $subTask->assigned_employee->name : '' }}
                        </td>
                    </tr>
                    {{-- <tr>
                        <th>
                        ...
                        <td>
                            @foreach($subTask->tags as $key => $tag)
                                <span class="label label-info">{{ isset($tag->name) ? $tag->name : ''  }}</span>
                            @endforeach
                        </td>
                    </tr> --}}
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ isset($subTask->due_date) ? $subTask->due_date : '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.subTask.fields.dependence') }}
                        </th>
                        @php
                            if($subTask->dependence != null){
                                $subtask = App\Models\SubTask::where('id',$subTask->dependence)->first();    
                            }
                        @endphp
                        <td>
                            {{ isset($subtask->name) ? $subtask->name : 'It is Not Dependent' }}
                        </td>
                    </tr>
                </tbody>
            </table>
