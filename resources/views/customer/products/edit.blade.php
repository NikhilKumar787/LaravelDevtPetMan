    ...
    <div class="card-body">
        <form method="POST" action="{{ route("customer.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_price') ? 'is-invalid' : '' }}" type="number" name="sales_price" id="sales_price" value="{{ old('sales_price', $product->sales_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cess') ? 'is-invalid' : '' }}" type="number" name="cess" id="cess" value="{{ old('cess', $product->cess) }}" step="1">
                @if($errors->has('cess'))
