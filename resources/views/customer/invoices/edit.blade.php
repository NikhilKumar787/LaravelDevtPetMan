    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.invoices.update", [$invoice->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Invoice::TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', $invoice->type) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('invoice_no') ? 'is-invalid' : '' }}" type="text" name="invoice_no" id="invoice_no" value="{{ old('invoice_no', $invoice->invoice_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_email') ? 'is-invalid' : '' }}" type="email" name="customer_email" id="customer_email" value="{{ old('customer_email', $invoice->customer_email) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('send_later') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="send_later" id="send_later" value="1" {{ $invoice->send_later || old('send_later', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('message_on_invoice') ? 'is-invalid' : '' }}" name="message_on_invoice" id="message_on_invoice">{{ old('message_on_invoice', $invoice->message_on_invoice) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('message_on_statement') ? 'is-invalid' : '' }}" name="message_on_statement" id="message_on_statement">{{ old('message_on_statement', $invoice->message_on_statement) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_amount') ? 'is-invalid' : '' }}" type="text" name="discount_amount" id="discount_amount" value="{{ old('discount_amount', $invoice->discount_amount) }}">
