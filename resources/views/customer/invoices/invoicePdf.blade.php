...
<div class="bg-white">
  ...
  <div class="company-details-box">
    <div class="company-list-detail-logo">
        <img class="img-fluid" src="{{ $company->company_logo->url ?? ''}}" width="100" height="100" alt="company_logo">
    </div>
  ...
  <table class="table bg-white table-bordered" style="">
      <thead>
        <tr>
          ...
          <h5><b>Company Details:</b></h5>
              ...
              <b>Address:</b>  {{isset($company->address_line_1) ? $company->address_line_1 : ''}},
                        {{isset($company->address_line_2) ? $company->address_line_2 : ''}}<br>
      ...
      {{-- <table class="tg" border="1" cellpadding="0" style="width:100%">
        <thead>
          <tr>
            <th class="tg-0lax" rowspan="2" style="width: 20%;text-align:center">Products</th>
            <th class="tg-0lax" rowspan="2" style="width: 12%;text-align:center">HSN/SAC</th>
            <th class="tg-0lax" rowspan="2" style="width: 15%;text-align:center;padding:1px 5px !important">Tax Percentage</th>
            <th class="tg-0lax" colspan="2" style="width: 15%;text-align:center;padding:1px 5px !important">Integrated Tax</th>
            <th class="tg-0lax" rowspan="2" style="width: 15%;text-align:center;padding:1px 5px !important">Tax Amount</th>
          </tr>
          <tr>
            <th class="tg-0lax" style=";text-align:center;padding:1px 5px !important">Rate</th>
            <th class="tg-0lax" style=";text-align:center;padding:1px 5px !important">Amount</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="tg-0lax" style="text-align: center">---</td>
            <td class="tg-0lax" style="text-align: center">----</td>
            <td class="tg-0lax" style="text-align: center">{{ $total_amount + $tax_value }}</td>
          </tr>
        </tbody>
        </table> --}}
        <div class="" style="">
