...
@can('customer_team_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @else
            <a class="btn btn-success" href="{{ route('customer.team.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.customer.fields.team') }}
            </a>
            @endif
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.customer.fields.team') }} {{ trans('global.list') }} (Total User: {{$team->team_limit}}/Remaining User: {{$team->team_limit - $user}})
    </div>
...
<script>
    $(function () {
        ...
        var url = "{{ route('customer.team.index') }}";
...
<script>
    function alertShow(){
     alert('Limit is over now , you can not add the team user more than 10');
 }
</script>
@endsection