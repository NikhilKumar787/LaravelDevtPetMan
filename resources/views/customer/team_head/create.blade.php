...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }}{{trans('cruds.customer.fields.team_head')}} {{ trans('cruds.user.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("customer.team-head.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="team_id" id="team_id" value="{{$team_details->email}}" readonly>
            </div>
            <div class="form-group">
