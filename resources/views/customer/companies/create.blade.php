    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.companies.store') }}" enctype="multipart/form-data" id="companyForm">
                ...
                <div class="form-group">
                    <label
                        for="password_for_reporting_portal">{{ trans('cruds.company.fields.password_for_reporting_portal') }}</label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('gstin') ? 'is-invalid' : '' }}" type="text"
                        name="gstin" id="gstin" value="{{ old('gstin', '') }}" required>
                    @if ($errors->has('gstin'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cin') ? 'is-invalid' : '' }}" type="text"
                        name="cin" id="cin" value="{{ old('cin', '') }}" required>
                    @if ($errors->has('cin'))
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('taxtube_teams') ? 'is-invalid' : '' }}" name="taxtube_teams"
                        ...
                        @foreach ($taxtubeTeams as $id => $team)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('taxtube_teams', [])) ? 'selected' : '' }}>{{ $team }}</option>
                        @endforeach
                    </select>
