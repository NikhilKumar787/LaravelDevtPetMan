                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('term_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.terms.index') }}">
                                    ...
                                    @can('account_name_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.account-names.index') }}">
                                    ...
                                    @can('assigned_task_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.assigned-tasks.index') }}">
                                            {{ trans('cruds.assignedTask.title') }}
                                        </a>
                                    @endcan
                                    @can('assigned_task_detail_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.assigned-task-details.index') }}">
